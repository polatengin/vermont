...
help:
	...
	@echo ""
	@echo "Runner Images:"
	@echo "  Vermont automatically builds GitHub Actions-compatible runner images when needed."
	@echo "  Available runners: ubuntu-latest, ubuntu-22.04, ubuntu-20.04, debian-latest,"
	@echo "  debian-12, debian-11, alpine-latest, centos-latest, centos-8, centos-7"
	@echo "  Images are built from Dockerfiles in the runners/ directory."
	@echo "  Use 'docker images | grep vermont-runner' to see built images."
